...
export default function SurveysPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
        <div className="max-w-md rounded-2xl border border-amber-200 bg-white p-8 text-center shadow-sm">
          <p className="text-lg font-semibold text-slate-900">Teacher Only</p>
          <p className="mt-2 text-sm text-slate-500">
            The survey builder is only available in the teacher workflow.
          </p>
        </div>
      </div>
    );
  ...
  return <SurveyBuilderView user={user} />;
}
